...
class DoctorController extends Controller
{
    ...
    public function filterBySpecialistAndHospital(
    SpecialistHospitalDoctorRequest $request
    ) {
    ...
    {
        try{
            $availablity = $this->doctorService->getAvailableSlots($doctorId);
            return response()->json(['data' => $availablity]);
        } catch(ModelNotFoundException $e){
            return response()->json(['message' => 'Doctor not found'], 404);
        }
    }
